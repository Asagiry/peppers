...
//логи с событий в логгер самописный
//с плагинами получается делаем два файла, по идее они должны иметь сопостовление jump -> space для клавы? спросить у начальника.
//два плагина получается сами решают активен экшен или нет и заставляют диспатчить? спросить у начальника. 